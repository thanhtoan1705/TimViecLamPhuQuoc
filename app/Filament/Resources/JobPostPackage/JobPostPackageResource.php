...
namespace App\Filament\Resources\JobPostPackage;
...
//    protected static ?string $navigationIcon = 'heroicon-o-briefcase';
    ...
    {
        return [
            'index' => Pages\ListJobPostPackages::route('/'),
            'create' => Pages\CreateJobPostPackage::route('/create'),
            'edit' => Pages\EditJobPostPackage::route('/{record}/edit'),
        ];
    }
}
