...
namespace App\Filament\Resources\UserJobPackage;
...
class UserJobPackageResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListUserJobPackages::route('/'),
            'create' => Pages\CreateUserJobPackage::route('/create'),
            'edit' => Pages\EditUserJobPackage::route('/{record}/edit'),
        ];
    }
}
