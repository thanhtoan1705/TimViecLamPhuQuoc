...
class BlogCategoryPolicy
{
    ...
    {
        return $user->can('view_any_admin::blog::category::blog::category');
    }
    ...
    {
        return $user->can('view_admin::blog::category::blog::category');
    }
    ...
    {
        return $user->can('create_admin::blog::category::blog::category');
    }
    ...
    {
        return $user->can('update_admin::blog::category::blog::category');
    }
    ...
    {
        return $user->can('delete_admin::blog::category::blog::category');
    }
    ...
    {
        return $user->can('delete_any_admin::blog::category::blog::category');
    }
