...
class JobTypePolicy
{
    ...
    {
        return $user->can('view_any_admin::job::type::job::type');
    }
    ...
    {
        return $user->can('view_admin::job::type::job::type');
    }
    ...
    {
        return $user->can('create_admin::job::type::job::type');
    }
    ...
    {
        return $user->can('update_admin::job::type::job::type');
    }
    ...
    {
        return $user->can('delete_admin::job::type::job::type');
    }
    ...
    {
        return $user->can('delete_any_admin::job::type::job::type');
    }
