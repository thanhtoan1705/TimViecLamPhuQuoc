...
const defaultLeftSections = ['personalInfo', 'skills', 'languages'];
const defaultRightSections = ['careerObjective', 'experience', 'education', 'projects', 'certificates'];

// Thêm icons cho các section
const sectionIcons = {
    personalInfo: 'bi bi-person',
    skills: 'bi bi-gear',
    languages: 'bi bi-translate',
    careerObjective: 'bi bi-bullseye',
    experience: 'bi bi-briefcase',
    education: 'bi bi-mortarboard',
    projects: 'bi bi-folder',
    certificates: 'bi bi-award'
};

const Template6 = ({data, onUpdate, isEditable, styles}) => {
    ...
    return (
        <div className="cv-template-6 template-wrapper" style={{
