@if($paginator->hasPages())
    <div class="paginations">
        <ul class="pager">
            ...
            @else
                <li><a class="pager-prev" href="{{ $paginator->appends(request()->except('page'))->previousPageUrl() }}"></a></li>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <li><a class="pager-next" href="{{ $paginator->appends(request()->except('page'))->nextPageUrl() }}"></a></li>
            @else
