                ...
                <div class="row login-register-cover">
                    <div class="col-lg-4 col-md-6 col-sm-12 mx-auto">
                        <div class="text-center">
                            ...
                            <h2 class="mt-10 mb-5 text-brand-1">Nhập mã OTP</h2>
                            <p class="font-sm text-muted mb-30">
                                Mã OTP đã được gửi đến số điện thoại của bạn. Vui lòng kiểm tra tin nhắn và nhập mã OTP vào
                                ô bên dưới
                            </p>
                        </div>
                        <form class="login-register text-start mt-20" action="#">
                            ...
                            <div class="d-flex justify-content-between">
                                <p>Thời hạn OTP: <span class="text-danger">03:56</span> </p>
                                <p>Gửi lại mã OTP</p>
                            </div>
                            <div class="form-group">
