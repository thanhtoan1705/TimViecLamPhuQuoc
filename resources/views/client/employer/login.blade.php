                ...
                <div class="row login-register-cover">
                    <div class="col-lg-4 col-md-6 col-sm-12 mx-auto">
                        <div class="text-center">
                            ...
                            <h2 class="mt-10 mb-5 text-brand-1">Đăng nhập nhà tuyển dụng</h2>
                        ...
                        <form class="login-register text-start mt-20" action="#">
                            <div class="form-group">
                                <label class="form-label" for="input-1">Tên người dùng hoặc Email *</label>
                            ...
                            <div class="login_footer form-group d-flex justify-content-between">
                                <label class="cb-container">
                                    <input type="checkbox"><span class="text-small">Ghi nhớ tôi<i></i></span><span
                            ...
                            <div class="text-muted text-center">Chưa có tài khoản? <a
                                    href="{{ route('employer.register') }}">Đăng
                                    ký</a></div>
                        </form>
                    </div>
